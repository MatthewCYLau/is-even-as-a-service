...
const HomePage = () => {
    ...
    const sections: Section[] = [
        ...
        {
            key: 'responsive',
            icon: <AspectRatioIcon className={styles.icon} color="primary" />,
            html: (
                <Typography>
        ...
        {
            key: 'theming',
            icon: <BrushIcon className={styles.icon} color="primary" />,
            html: (
                <Typography>
        ...
        {
            key: 'appearance',
            icon: <BrightnessIcon className={styles.icon} color="primary" />,
            html: (
                <Typography>
